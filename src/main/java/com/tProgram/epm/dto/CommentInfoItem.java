...
import com.tProgram.epm.mbg.model.Collect;
...
public class CommentInfoItem {
    ...
    public CommentInfoItem(CommentInfo commentInfo) {
    ...
    public CommentInfoItem(Integer commentId){
        this.commentId = commentId;
    }

    public CommentInfoItem(Collect collect){
        this.commentId = collect.getCommentId();
        this.isCollect = true;
        SimpleDateFormat dateToString = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        this.collectTime = dateToString.format(collect.getUpdateTime());
    }
}
